...
void ButtonDisplay(BUTTON *b)
    ...
    VioWrtCharStrAtt("É",1,row,startcol,&cell[1],VIOHDL);
                                                // write the top line
    ...
    VioWrtCharStrAtt("º",1,++row,startcol,&cell[1],VIOHDL);
    text = b->text;                             // reset pointer
                                                //
                                                // write the message
    VioWrtCharStrAtt(text,strlen(text),row,startcol+1,&cell[1],VIOHDL);
                                                // write the right border  
    VioWrtCharStrAtt("º",1,row,endcol,&cell[1],VIOHDL);
                                                // write the 3rd corner    
    VioWrtCharStrAtt("È",1,++row,startcol,&cell[1],VIOHDL);
