...
typedef  DWORD  PRICE;      /* dollar amt * iDenominator + fractional amount */
...
typedef struct tagInCoreStockInfo
{
  ...
  HANDLE    hTicks;
  WORD      nTicksAllocated; /* how large the ticker array is           */
...
BOOL FAR PASCAL GraphOptionsDlgProc(HWND, WORD, WORD, LONG);
