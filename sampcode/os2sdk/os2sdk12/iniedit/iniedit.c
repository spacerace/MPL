...
VOID ReadIni()
{
    ...
    for( i=0; i<cAppNames; i++ )
        ...
        // Remember that incrementing a pointer automatically mult by size of item
        pPairsAlloc += cPairs;
            ...
            switch( SHORT1FROMMP(mp1) )
                ...
                case IDI_LIST:
                    ...
                    if( SHORT2FROMMP(mp1) == LN_ENTER )
                        ...
                        Index = SHORT1FROMMR(WinSendMsg( hwndList, LM_QUERYSELECTION,
                                (MPARAM)0, (MPARAM)0 ));
                        ...
                        if( usFormat == APP_FORM )
                            ...
                            if( szBuf[0] != ' ')
                                ...
                                if( WinProcessDlg( hwndDialog ) == IDDI_CHANGE_KEY_OK )
                                    {
                                    TopIndex = SHORT1FROMMR(WinSendMsg( hwndList, LM_QUERYTOPINDEX,
                        ...
                        if( fScroll )
                            ...
                            Index = SHORT1FROMMR(WinSendMsg( hwndList, LM_SEARCHSTRING,
