...
USHORT id;
{
	...
	if (global.cThr < MAX_THREADS)
	{
		...
		global.bm.cPlanes   = 0;
		global.bm.cBitCount = 0;
		if (!WinDlgBox( HWND_DESKTOP, hwnd, (PFNWP)BitmapParamsDlg, (HMODULE) NULL,
...
USHORT id;
{
    ...
    case IDM_PTRPREFERENCES:
	WinDlgBox( HWND_DESKTOP, hwnd, (PFNWP)PtrPreferencesDlg, (HMODULE) NULL,
...
USHORT id;
{
	...
	if (WinDlgBox( HWND_DESKTOP, hwnd, (PFNWP)LineAttrsDlg, (HMODULE) NULL,
	...
	if (global.fUpdateAttrs && (global.flMarkerAttrs & LFA_MARKALL))
	    MyMessageBox(hwnd, pszAttrs);
	if (WinDlgBox( HWND_DESKTOP, hwnd, (PFNWP)MarkerAttrsDlg, (HMODULE) NULL,
	...
	if (global.fUpdateAttrs && (global.flAreaAttrs & LFA_AREAALL))
	    MyMessageBox(hwnd, pszAttrs);
	if (WinDlgBox( HWND_DESKTOP, hwnd, (PFNWP)AreaAttrsDlg, (HMODULE) NULL,
	...
	if (global.fUpdateAttrs && (global.flImageAttrs & LFA_IMAGEALL))
	    MyMessageBox(hwnd, pszAttrs);
	if (WinDlgBox( HWND_DESKTOP, hwnd, (PFNWP)ImageAttrsDlg, (HMODULE) NULL,
	...
	if (global.fUpdateAttrs && (global.flMiscAttrs & (LFA_RECURSION |
	    ...
	    MyMessageBox(hwnd, pszAttrs);
	if (WinDlgBox( HWND_DESKTOP, hwnd, (PFNWP)MiscAttrsDlg, (HMODULE) NULL,
	...
	if (global.fUpdateAttrs && (global.flMiscAttrs & (LFA_XOFF |
	    ...
	    MyMessageBox(hwnd, pszAttrs);
	if (WinDlgBox( HWND_DESKTOP, hwnd, (PFNWP)DimensionsDlg, (HMODULE) NULL,
...
HWND hwnd;
{
	...
	GpiBitBlt(global.CutCopyPS, global.pThrTop->hps, 3L, aptl, ROP_SRCCOPY, 0L);
...
HWND hwnd;
{
	...
	else
	{
	    ...
	    GpiBitBlt(global.pThrTop->hps, global.CutCopyPS, 3L, aptl, global.ulPasteROP, 0L);
