...
ULONG EXPENTRY	 LineFracWndProc    (HWND, USHORT, MPARAM, MPARAM);
VOID		 LfClose	    (HWND);
...
#ifdef INCL_LFDLG
/* lfdlg.c */
ULONG EXPENTRY	 AboutDlg	   (HWND, USHORT, MPARAM, MPARAM);
ULONG EXPENTRY	 TimerDelayDlg	   (HWND, USHORT, MPARAM, MPARAM);
ULONG EXPENTRY	 BitmapParamsDlg   (HWND, USHORT, MPARAM, MPARAM);
ULONG EXPENTRY	 SwitchDelayDlg    (HWND, USHORT, MPARAM, MPARAM);
ULONG EXPENTRY	 LineAttrsDlg	   (HWND, USHORT, MPARAM, MPARAM);
ULONG EXPENTRY	 MarkerAttrsDlg    (HWND, USHORT, MPARAM, MPARAM);
ULONG EXPENTRY	 AreaAttrsDlg	   (HWND, USHORT, MPARAM, MPARAM);
ULONG EXPENTRY	 ImageAttrsDlg	   (HWND, USHORT, MPARAM, MPARAM);
ULONG EXPENTRY	 MiscAttrsDlg	   (HWND, USHORT, MPARAM, MPARAM);
ULONG EXPENTRY	 DimensionsDlg	   (HWND, USHORT, MPARAM, MPARAM);
ULONG EXPENTRY	 PtrPreferencesDlg (HWND, USHORT, MPARAM, MPARAM);
#endif
