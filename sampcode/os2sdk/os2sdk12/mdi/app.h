...
/* So that we don't have to use -Gw any more. */
#ifdef	EXPENTRY
#undef	EXPENTRY
#endif
...
#define CHANGEMENU         /* allow toggling of main menu bar depending
                              on which doc is active */


#define IDR_MDI             1

#define IDR_DOC1MENU        11
#define IDR_DOC2MENU        12
#define IDR_DOC3MENU        13
#define IDR_DOC4MENU        14
#define IDR_DOC5MENU        15
#define IDR_DOCXMENU        16
...
typedef struct _DOC {   /* doc */
    ...
    HWND    hwndMainMenu;   /* The main menu bar for when this doc is active */
                            /* added 17-Oct-1989 by johnba */
    BOOL    fAabSysMenu;
