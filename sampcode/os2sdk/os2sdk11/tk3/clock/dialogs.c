...
*/
MRESULT CALLBACK ClkAboutDlgProc ( HWND hwnd , USHORT usMsg ,
...
/*
    ...
    Returns: MRESULT, 0 or return value from WinDefDlgProc
*/
MRESULT CALLBACK ClkTicksDlgProc ( HWND hwnd , USHORT usMsg ,
				   MPARAM mp1 , MPARAM mp2 )
{
...
/*
    ...
    Returns: MRESULT, 0 or return value from WinDefDlgProc
*/
MRESULT CALLBACK ClkColorsDlgProc ( HWND hwnd , USHORT usMsg ,
				   MPARAM mp1 , MPARAM mp2 )
{
    USHORT usButtonID ;
