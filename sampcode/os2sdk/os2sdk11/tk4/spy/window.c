...
MRESULT	CALLBACK SpyWindowsDlgProc(HWND, USHORT, MPARAM, MPARAM);




/***************************************************************************\
* MRESULT CALLBACK SpyWindowsDlgProc(hwnd, msg, mp1, mp2)
*
...
HWND            hwnd;
{
    ...
    if (hwnd != hwndWinDlgDisp)
    {
        ...
        sprintf(szTemp, "0x%04x", (SHORT)hwnd);
        ...
        sprintf(szTemp, "0x%04x", (SHORT)hwndParent);
...
SHORT       wLevel;
{
    ...
    cch = sprintf(szTemp,
        ...
        ++wDumpCount, (SHORT)hwnd, wLevel, (SHORT)hwndParent,
        (SHORT)hwndChild, (SHORT)hwndOwner, id, (SHORT)ulHMQ,
