...
/* Function Prototypes */
MRESULT CALLBACK SpyQueuesDlgProc(HWND, USHORT, MPARAM, MPARAM);
...
/***************************************************************************\
* MRESULT CALLBACK SpyQueuesDlgProc(hwnd, msg, mp1, mp2)
*
...
MPARAM mp2;
{
    ...
    case WM_COMMAND:
        ...
        case DID_WUNSELALL:
            fSelect = FALSE;
        case DID_WSELALL:
            cQueues = (SHORT) WinSendMsg(hwndWindowLB, LM_QUERYITEMCOUNT,
                0L, 0L);
...
HMQ             hmqDisp;
{
    ...
    if (hmqDisp != hmqDlgDisp)
    {
        ...
        sprintf(szTemp, "0x%04x", (SHORT)hmqDisp);
